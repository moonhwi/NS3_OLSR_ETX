...
struct RoutingTableEntry
{
  ...
  float etxDistance; //!< Distance in sum Etx to the destination.
...
private:
  ...
  std::vector<EtxData> m_EtxDataTable;
...
private:
  ...
  /**
   * \brief Updates the EtxDataTable according to the information contained in
