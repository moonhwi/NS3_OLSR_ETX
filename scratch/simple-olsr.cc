...
int main(int argc, char *argv[])
{
  ...
  p2p.EnableAsciiAll(ascii.CreateFileStream("simple-olsr/simple-point-to-point-olsr.tr"));
  p2p.EnablePcapAll("simple-olsr/simple-point-to-point-olsr");
  Ipv4GlobalRoutingHelper routingHelper;
  OutputStreamWrapper *stream = new OutputStreamWrapper("simple-olsr/routes.route", std::ios::ate);
  routingHelper.PrintRoutingTableAllEvery(Seconds(1.0), stream, Time::S);
